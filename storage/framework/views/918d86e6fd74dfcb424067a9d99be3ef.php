        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-slate-200">
            <div>
                ...
                <a href="<?php echo e(route('events.show', $previousEvent->slug)); ?>" class="group block max-w-[280px] mr-auto">
                    ...
                    <h4 class="mt-3 font-bold text-slate-800 group-hover:text-[#f97316] transition-colors line-clamp-2 text-left"><?php echo e($previousEvent->title); ?></h4>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="text-right">
                ...
                <a href="<?php echo e(route('events.show', $nextEvent->slug)); ?>" class="group block max-w-[280px] ml-auto">
                    ...
                    <h4 class="mt-3 font-bold text-slate-800 group-hover:text-[#f97316] transition-colors line-clamp-2 text-right"><?php echo e($nextEvent->title); ?></h4>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kienxinhzai\Downloads\ThucTap-tuan\resources\views/events/show.blade.php ENDPATH**/ ?>