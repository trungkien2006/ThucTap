...
<section id="upcoming-vertical" class="relative w-full z-[30] rounded-t-[3rem] shadow-[0_-20px_40px_-15px_rgba(0,0,0,0.05)] pt-12 lg:pt-16" style="background:#FFFBEA; font-family: 'Inter', sans-serif;">
    <div class="upcoming-pinned-container hidden lg:block">
        ...
        <div class="upcoming-vertical-stack">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasEvents): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = array_slice($upcoming, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php 
                        $img = !empty($u['images']) ? $u['images'][0] : (!empty($u['img']) ? $u['img'] : 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1600&q=80');
                        $zIndex = $idx + 1;
                    ?>
                    <div class="upcoming-panel text-[#1C1410]" style="z-index: <?php echo e($zIndex); ?>;" data-index="<?php echo e($idx); ?>">
                        <!-- Center Image Frame -->
                        <div class="slide-image-frame pointer-events-auto">
                            <div tabindex="0" class="slide-image-inner bg-gray-200 relative group overflow-hidden cursor-pointer focus:outline-none"
                                 x-data="{ active: 0, images: <?php echo e(json_encode(!empty($u['images']) ? $u['images'] : (!empty($u['img']) ? [$u['img']] : ['https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1600&q=80']))); ?> }">
...
<style>
    ...
    .group:hover .custom-blur-img-upcoming {
        filter: blur(12px) brightness(0.35) !important;
                                ...
                                <template x-for="(imgSrc, i) in images" :key="i">
                                    <img :src="imgSrc" :alt="`<?php echo e($u['name'] ?? $u['title'] ?? ''); ?> - Hình ${i+1}`" 
                                ...
                                <div class="absolute inset-0 px-8 pt-8 md:px-12 md:pt-12 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-30 pointer-events-none">
                                    ...
                                    <h3 class="font-black uppercase text-[16px] md:text-[20px] tracking-widest mb-4 drop-shadow-lg" style="color: #FFC107;">
                                        <?php echo e($u['category'] ?? 'Sự kiện'); ?>

                                    </h3>
                                    
                                    <!-- White Description Text -->
                                    <div class="text-white text-[16px] md:text-[18px] leading-relaxed drop-shadow-lg font-medium max-w-3xl">
                                        <strong class="block mb-3 text-[28px] md:text-[40px] font-black leading-tight line-clamp-3"><?php echo e($u['name'] ?? $u['title'] ?? ''); ?></strong>
                                    </div>
                                    <div class="text-white text-[16px] md:text-[18px] leading-relaxed drop-shadow-lg font-medium max-w-3xl">
                                        <span class="block line-clamp-4 text-white/95"><?php echo e($u['summary'] ?? ''); ?></span>
                                    </div>
                                    ...
                                    <div class="absolute bottom-[50px] left-8 right-8 md:left-12 md:right-12 flex flex-col gap-3 pointer-events-auto">
                                        ...
                                        <div class="flex items-start gap-3 text-white/90 text-[16px] font-medium">
                                            ...
                                            <span class="line-clamp-2 max-w-lg"><?php echo e($u['location'] ?? 'Sẽ thông báo sau'); ?></span>
                                        </div>
                                        
                                        <!-- Action Button -->
                                        <div class="mt-4 pointer-events-auto">
                                            <a href="<?php echo e(route('events.show', $u['slug'])); ?>" class="inline-flex items-center gap-3 text-white text-[14px] font-bold tracking-[0.15em] group/btn w-fit uppercase hover:text-[#FFC107] transition-colors" style="text-decoration: none;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasEvents && count($upcoming) > 1): ?>
    ...
    <div class="block lg:hidden px-4 pb-8 pt-6"
         x-data="{
            items: <?php echo e(json_encode(collect($upcoming)->map(function($u) {
                $img = !empty($u['images']) ? $u['images'][0] : (!empty($u['img']) ? $u['img'] : 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=1600&q=80');
...
<?php /**PATH C:\Users\admin\Downloads\ThucTap-main\ThucTap-main\resources\views/frontend/upcoming-mobile.blade.php ENDPATH**/ ?>