...
<body class="font-sans antialiased text-slate-800">
    ...
    <header class="fixed top-0 left-0 w-full h-[64px] z-40 flex items-center justify-between px-6 bg-white border-b border-slate-200 shadow-sm">
        ...
        <div class="flex items-center justify-end w-[240px]">
            <a href="{{ route('admin.events.design', $event) }}" class="flex items-center gap-1 px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-[13px] font-medium transition-all">
                Bỏ qua
        ...
        <aside class="tp-sidebar">
            ...
            <div class="tp-sidebar-nav">
                ...
                <button class="tp-cat-btn">
                    <span class="flex items-center gap-2"><span class="material-symbols-outlined text-[18px]">folder</span> {{ $cat->name }}</span>
                </button>
                @endforeach
            </div>
        </aside>
        ...
        <main class="tp-main">
            ...
            <div class="tp-grid-scroll">
                <div class="tp-grid cols-2" id="templateGrid">
                    ...
                    <!-- Template 1 -->
                    <div class="tp-card {{ ($event->page_template == 1 || $event->page_template == null) ? 'active' : '' }}" id="card-1" onclick="selectTemplate(1)" style="cursor: pointer;">
                    ...
                    <!-- Template 2 -->
                    <div class="tp-card {{ $event->page_template == 2 ? 'active' : '' }}" id="card-2" onclick="selectTemplate(2)" style="cursor: pointer;">
                    ...
                    <!-- Template 3 -->
                    <div class="tp-card {{ $event->page_template == 3 ? 'active' : '' }}" id="card-3" onclick="selectTemplate(3)" style="cursor: pointer;">
        ...
        <aside class="tp-preview-panel" id="previewPanel">
            ...
            <div class="p-4 border-t border-slate-200 bg-white">
                <form action="{{ route('admin.events.save_template', $event) }}" method="POST">
                    @csrf
                    <input type="hidden" name="page_template" id="formCurrentTemplateId" value="{{ $event->page_template ?? 1 }}">
