...
<head>
    ...
    <title>UniEvents | Studio — {{ $event->title }} | Mẫu 1</title>
    ...
    <style>
        ...
        /* Template 1 canvas: light background */
            ...
            <div class="max-w-[1140px] mx-auto px-6 mt-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="uni-card p-6">
                        ...
                        <div class="mb-4 bg-orange-50 text-orange-700 p-3 rounded-lg text-[13px] border border-orange-200">
                            <span class="material-symbols-outlined align-middle mr-1 text-[18px]">swap_horiz</span>
                            <b>Mẫu 1 — Tiêu chuẩn Zic-Zac:</b> Ảnh và nội dung sẽ luân phiên trái-phải theo từng ô.
                        </div>
