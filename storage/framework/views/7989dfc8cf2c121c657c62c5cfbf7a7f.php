...
<head>
    ...
    <title><?php echo e($pageTitle ?? 'UniEvent Admin'); ?> · UniEvent Admin</title>
...
<body class="overflow-x-clip bg-background text-foreground font-body admin-body admin-bg-gradient">
    ...
    <aside id="sidebar" class="fixed left-0 top-0 h-full flex flex-col border-r border-border z-50">
        ...
        <nav class="flex-1 overflow-y-auto scrollbar-hide space-y-4" id="sidebarNav">
            ...
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="sidebar-menu-btn text-violet-600 hover:text-violet-700 hover:bg-violet-50/50 bg-white/40 mb-2 border border-violet-200/50 backdrop-blur-sm rounded-xl">
            ...
            <div>
                ...
                <div class="space-y-0.5">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                        <i data-lucide="layout-dashboard" class="h-5 w-5 shrink-0"></i>
                        <span class="sidebar-text-element">Tổng quan</span>
                    </a>
                    <a href="<?php echo e(route('admin.events.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.events.*') && !request()->routeIs('admin.events.create') && !request()->routeIs('admin.events.edit') && !request()->routeIs('admin.events.design') && !request()->routeIs('admin.events.preview') && !request()->routeIs('admin.events.show') ? 'active' : ''); ?>">
                        <i data-lucide="calendar" class="h-5 w-5 shrink-0"></i>
                        <span class="sidebar-text-element">Sự kiện</span>
                    </a>
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                        <i data-lucide="tag" class="h-5 w-5 shrink-0"></i>
                        <span class="sidebar-text-element">Danh mục sự kiện</span>
                    </a>
                    <a href="<?php echo e(route('admin.departments.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.departments.*') ? 'active' : ''); ?>">
                        <i data-lucide="building" class="h-5 w-5 shrink-0"></i>
                        <span class="sidebar-text-element">Chuyên ngành</span>
                    </a>
                    <a href="<?php echo e(route('admin.archive.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.archive.*') ? 'active' : ''); ?>">
                        <i data-lucide="archive" class="h-5 w-5 shrink-0"></i>
                        <span class="sidebar-text-element">Lưu trữ sự kiện</span>
                    </a>
                    <a href="<?php echo e(route('admin.speakers.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->is('admin/speakers*') ? 'active' : ''); ?>">
            ...
            <div>
                ...
                <div class="space-y-0.5">
                    <a href="<?php echo e(route('admin.media.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.media.*') ? 'active' : ''); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isSuperAdmin()): ?>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-menu-btn rounded-xl <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
            ...
            <div class="relative">
                <button id="adminAvatarBtn" class="mb-2">
                    ...
                    <div class="min-w-0 flex-1 text-left sidebar-text-element">
                        <div class="text-xs font-semibold truncate text-foreground"><?php echo e(Auth::user()->name); ?></div>
                        <div class="text-[11px] text-muted-foreground truncate"><?php echo e(Auth::user()->email); ?></div>
                    </div>
                ...
                <div id="adminAvatarDropdown" class="absolute bottom-full left-0 right-0 mb-2 bg-white border border-border rounded-md shadow-lg py-1 hidden z-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isSuperAdmin()): ?>
                        <a href="<?php echo e(route('admin.users.create')); ?>" class="flex items-center px-3 py-2 text-xs text-foreground hover:bg-accent">
                            <i data-lucide="user-plus" class="h-3.5 w-3.5 mr-2"></i> Tạo tài khoản
                        </a>
                        <div class="h-px bg-border my-1"></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(route('admin.profile.edit')); ?>" class="flex items-center px-3 py-2 text-xs text-foreground hover:bg-accent">
                        <i data-lucide="settings" class="h-3.5 w-3.5 mr-2"></i> Cài đặt tài khoản
                    </a>
                    <a href="<?php echo e(route('admin.profile.activity')); ?>" class="flex items-center px-3 py-2 text-xs text-foreground hover:bg-accent">
    ...
    <header id="topHeader" class="fixed top-0 right-0 h-16 z-30 flex items-center gap-2 bg-background/80 backdrop-blur-md border-b border-border/50 px-3 md:px-4 justify-between transition-all">
        <div class="flex items-center gap-2 min-w-0">
            ...
            <div class="hidden md:flex items-center text-xs text-muted-foreground gap-1 min-w-0">
                <div class="flex items-center gap-1 min-w-0">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" wire:navigate class="hover:text-foreground">Home</a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($breadcrumbs) && is_array($breadcrumbs)): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <i data-lucide="chevron-right" class="h-3 w-3 shrink-0"></i>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($bc['route'])): ?>
                                <a href="<?php echo e($bc['route']); ?>" wire:navigate class="hover:text-foreground truncate"><?php echo e($bc['label']); ?></a>
                            <?php else: ?>
                                <span class="text-foreground font-medium truncate"><?php echo e($bc['label']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <?php else: ?>
                        <i data-lucide="chevron-right" class="h-3 w-3 shrink-0"></i>
                        <span class="text-foreground font-medium truncate"><?php echo e($pageTitle ?? 'Dashboard'); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <!-- Global Search Bar -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!isset($hideTopMenu) || !$hideTopMenu): ?>
        <div class="flex-1 max-w-2xl px-4 hidden md:flex items-center justify-center">
            <form action="<?php echo e(route('admin.events.index')); ?>" method="GET" class="flex items-center w-full max-w-md gap-2">
                <div class="relative flex-1 group">
                    ...
                    <input type="text" name="search" placeholder="Tìm kiếm sự kiện, danh mục..." value="<?php echo e(request('search')); ?>"
        ...
        <div class="flex items-center gap-2 md:gap-3">
            ...
            <div class="relative">
                ...
                <div id="notificationDropdown" class="absolute right-0 top-full mt-2 w-80 bg-card border border-border rounded-xl shadow-xl py-1 z-50 overflow-hidden hidden">
                    <div class="px-4 py-3 text-[13px] font-semibold text-foreground flex justify-between items-center bg-muted/30">
                        <span>Thông báo</span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notificationCount > 0): ?>
                            <span class="bg-primary/10 text-primary text-[10px] px-2 py-0.5 rounded-full font-medium"><?php echo e($notificationCount); ?> mới</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="max-h-[300px] overflow-y-auto">
                        ...
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionError): ?>
                                <div class="block p-3.5 hover:bg-muted/50 transition-colors border-t border-border/50 first:border-0 group bg-red-50/50">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-[11px] text-muted-foreground mt-0.5"><?php echo e($sessionError); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sessionSuccess): ?>
                                <div class="block p-3.5 hover:bg-muted/50 transition-colors border-t border-border/50 first:border-0 group bg-emerald-50/50">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-[11px] text-muted-foreground mt-0.5"><?php echo e($sessionSuccess); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $startingSoon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $diffMin = max(1, round($nowTime->diffInMinutes($evt->event_date)));
                                ?>
                                <a href="<?php echo e(route('admin.events.show', $evt)); ?>" class="block p-3.5 hover:bg-muted/50 transition-colors border-t border-border/50 first:border-0 group">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-[13px] font-medium text-foreground line-clamp-1 group-hover:text-primary transition-colors"><?php echo e($evt->title); ?></p>
                                            <p class="text-[11px] text-muted-foreground mt-0.5 flex items-center gap-1">
                                                <span class="w-1.5 h-1.5 rounded-full bg-amber-500"></span> Bắt đầu sau <?php echo e($diffMin); ?> phút
                                            </p>
                                        </div>
                                    </div>
                                </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $runningEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                <a href="<?php echo e(route('admin.events.show', $evt)); ?>" class="block p-3.5 hover:bg-muted/50 transition-colors border-t border-border/50 first:border-0 group">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-[13px] font-medium text-foreground line-clamp-1 group-hover:text-primary transition-colors"><?php echo e($evt->title); ?></p>
                                            <p class="text-[11px] text-muted-foreground mt-0.5 flex items-center gap-1">
                                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> Đang diễn ra (còn <?php echo e($diffEndStr); ?>)
                                            </p>
                                        </div>
                                    </div>
                                </a>
            ...
            <!-- Public site link -->
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="h-11 w-11 text-muted-foreground hover:text-foreground hover:bg-accent rounded-xl flex items-center justify-center transition-all" title="Xem trang công khai" wire:navigate>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div class="bg-card border-l-4 border-emerald-500 shadow-xl rounded-lg px-4 py-3 flex items-start gap-3 w-80 animate-in slide-in-from-right-8 fade-in pointer-events-auto" id="toast-success">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-muted-foreground mt-0.5"><?php echo e(session('success')); ?></p>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
            <div class="bg-card border-l-4 border-red-500 shadow-xl rounded-lg px-4 py-3 flex items-start gap-3 w-80 animate-in slide-in-from-right-8 fade-in pointer-events-auto" id="toast-error">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-muted-foreground mt-0.5"><?php echo e(session('error')); ?></p>
                </div>
...
<?php /**PATH C:\Users\admin\Downloads\ThucTap-main\ThucTap-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>