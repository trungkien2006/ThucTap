...
<section class="gw-hero">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->bannerImage && $event->bannerImage->url): ?>
        <img class="gw-hero-img"
             src="<?php echo e(\App\Helpers\FileHelper::url($event->bannerImage->url)); ?>"
    ...
    <div class="gw-hero-title-block">
        <div class="gw-hero-eyebrow">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->category): ?><?php echo e($event->category->name); ?><?php else: ?> Sự kiện <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div class="gw-hero-name"><?php echo e($event->title); ?></div>
    </div>
    <div class="gw-hero-meta">
        <div class="gw-hero-date"><?php echo e($event->event_date->format('d/m/Y')); ?></div>
        ...
        <div class="gw-hero-location"><?php echo e($event->location); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</section>
        ...
        <div class="gw-card gw-fade-in">
            ...
            <div class="gw-info-group">
                ...
                <div class="gw-info-value">
                    <?php echo e($event->event_date->format('l, d/m/Y')); ?><br>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->end_date): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->event_date->isSameDay($event->end_date)): ?>
                            - <?php echo e($event->end_date->format('H:i')); ?>

                        <?php else: ?>
                            - <?php echo e($event->end_date->format('H:i d/m/Y')); ?>
            ...
            <div class="gw-info-group">
                ...
                <div class="gw-info-value"><?php echo e($event->location); ?></div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="gw-info-group">
                ...
                <div class="gw-info-value"><?php echo e($event->category->name); ?></div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php
            ...
            <div style="margin-top:36px;">
                ...
                <div id="gw-countdown" style="display:flex;gap:12px;justify-content:center;align-items:flex-end;" data-target="<?php echo e($event->event_date->toIso8601String()); ?>">
            ...
            <div style="margin-top:36px;display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <span style="font-size:0.82rem;color:#b8bcb8;font-family:'DM Sans',sans-serif;">Kết thúc ngày <?php echo e($event->event_date->format('d/m/Y')); ?></span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="gw-container">
        ...
        <div class="gw-schedule-grid">
            ...
            <div class="gw-schedule-item gw-fade-in text-center p-6 bg-[#f4f7f4] rounded-2xl">
                <div class="gw-schedule-time text-[1.4rem] font-bold text-[#5d7a5c] mb-2"><?php echo e($item->start_time->format('H:i')); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->end_time): ?> – <?php echo e($item->end_time->format('H:i')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                <div class="gw-schedule-name text-[1.6rem] font-medium text-[#3d4438] mb-2"><?php echo e($item->title); ?></div>
                ...
                <div class="gw-schedule-desc text-[#6e7a6a]"><?php echo e($item->description); ?></div>
                <?php elseif($item->speaker): ?>
                <div class="gw-schedule-desc text-[#6e7a6a]"><?php echo e($item->speaker->name); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
...
<?php $pb = $event->subBannerImage; ?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pb && $pb->url): ?>
<div><img src="<?php echo e(\App\Helpers\FileHelper::url($pb->url)); ?>" alt="<?php echo e($event->title); ?>" class="gw-full-photo"></div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRecap): ?>
...
<section class="gw-section" id="gw-story">
    <div class="gw-container-lg">
        ...
        <div class="gw-story-split">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isJsonDesc && !empty(trim(strip_tags($event->description)))): ?>
            <div class="gw-story-row gw-fade-in">
                <div class="gw-story-left" style="padding-top: 0;">
                    <div class="gw-story-body"><?php echo nl2br(e($event->description)); ?></div>
                </div>
                <div class="gw-story-right">
                    <?php $firstImg = $event->galleryImages->where('type','image')->first(); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($firstImg && $firstImg->url): ?>
                    <div class="gw-sticky-wrapper">
                        <img src="<?php echo e(\App\Helpers\FileHelper::url($firstImg->url)); ?>" class="gw-sticky-media" loading="lazy">
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $remainingBlocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($block->content) || $block->url): ?>
            <div class="gw-story-row gw-fade-in">
                <div class="gw-story-left">
                    ...
                    <?php $isJ=false; $cd=@json_decode($block->content,true); if(json_last_error()===JSON_ERROR_NONE && is_array($cd))$isJ=true; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isJ): ?><div class="gw-story-body" style="margin-bottom:24px;"><?php echo $block->content; ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div style="margin-top:16px;">
                        <a href="<?php echo e($block->action_url); ?>" target="_blank" class="gw-btn">
                            <?php echo e($block->action_label ?? 'Truy cập liên kết'); ?>
                ...
                <div class="gw-story-right">
                    ...
                    <div class="gw-sticky-wrapper">
                        ...
                        <video src="<?php echo e(\App\Helpers\FileHelper::url($block->url)); ?>" class="gw-sticky-media" autoplay loop muted playsinline controls></video>
                        <?php else: ?>
                        <img src="<?php echo e(\App\Helpers\FileHelper::url($block->url)); ?>" alt="<?php echo e($block->caption ?? ''); ?>" class="gw-sticky-media" loading="lazy">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->caption): ?><p style="margin-top:10px;font-size:1.01rem;color:#9aa09a;font-style:italic;"><?php echo e($block->caption); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($t2_speakers->count() > 0): ?>
        <div class="gw-fade-in" style="margin-top:40px;">
            ...
            <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:24px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $t2_speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="gw-speaker-block" style="margin-top:0;display:flex;align-items:center;gap:20px;padding:24px;background:#fff;border:1px solid rgba(61,68,56,0.1);border-radius:4px;width:100%;max-width:350px;">
                    <img src="<?php echo e($speaker->photo_url ? asset($speaker->photo_url) : 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80'); ?>"
                         alt="<?php echo e($speaker->name); ?>" style="width:80px;height:80px;border-radius:50%;object-fit:cover;flex-shrink:0;">
                    <div>
                        <div style="font-size:1.15rem;font-weight:600;color:#3d4438;margin-bottom:4px;"><?php echo e($speaker->name); ?></div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speaker->title): ?><div style="font-size:0.9rem;color:#5d7a5c;font-family:'DM Sans',sans-serif;"><?php echo e($speaker->title); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speaker->bio): ?><div style="font-size:0.85rem;color:#9aa09a;margin-top:6px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;"><?php echo e($speaker->bio); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRecap): ?>
    ...
    <div x-show="activeTab === 'images'" class="tab-content-images" style="display: none; width: 100%; margin-top: 2rem;">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4 max-w-[1140px] mx-auto mb-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recapImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="aspect-square relative rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group cursor-pointer bg-slate-100">
                <img src="<?php echo e(\App\Helpers\FileHelper::url($img->url)); ?>" 
                     alt="<?php echo e($img->caption ?? 'Hình ảnh sự kiện'); ?>" 
...
<section class="gw-section" style="padding:48px 24px;" id="gw-reactions">
    <div class="gw-reactions" style="flex-wrap: wrap;" x-data="{ copied: false }">
        <button id="like-btn" data-event-id="<?php echo e($event->id); ?>"
                class="gw-like-btn <?php echo e(session()->has('liked_events.' . $event->id) ? 'liked' : ''); ?>">
            <span class="material-symbols-outlined" style="font-size:23px;">favorite</span>
            <span id="likes-count"><?php echo e($event->likes_count); ?></span> Yêu thích
        </button>
    ...
    <div style="max-width:860px;margin:48px auto 0;display:grid;grid-template-columns:1fr 1fr;gap:24px;">
        <div>
            ...
            <a href="<?php echo e(route('events.show', $previousEvent->slug)); ?>" style="display:block;color:#3d4438;text-decoration:none;">
                ...
                <strong style="font-family:'Cormorant Garamond',serif;font-size:1.43rem;font-weight:400;"><?php echo e($previousEvent->title); ?></strong>
            </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div style="text-align:right;">
            ...
            <a href="<?php echo e(route('events.show', $nextEvent->slug)); ?>" style="display:block;color:#3d4438;text-decoration:none;">
                ...
                <strong style="font-family:'Cormorant Garamond',serif;font-size:1.43rem;font-weight:400;"><?php echo e($nextEvent->title); ?></strong>
            </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kienxinhzai\Downloads\ThucTap-tuan\resources\views/events/show-template2.blade.php ENDPATH**/ ?>