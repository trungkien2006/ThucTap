        ...
        <section class="uni-card p-6 space-y-5">
            ...
            <div class="mt-5">
                ...
                <div class="relative">
                    ...
                    <input class="uni-input pl-10" id="registration_link" name="registration_link" value="{{ old('registration_link', $event->registration_link) }}" type="url" placeholder="VD: https://docs.google.com/forms/..."/>
                </div>
