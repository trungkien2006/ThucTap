...
<div class="t5-body">
    <div class="t5-container">
        ...
        <div class="t5-hero-section">
            <div class="t5-hero-subtitle" style="text-transform: uppercase; letter-spacing: 0.15em;"><?php echo e($event->category ? $event->category->name : 'SỰ KIỆN ĐẶC BIỆT'); ?></div>
                ...
                <div class="t5-polaroid torn">
                    <div class="t5-polaroid-img-wrap">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->bannerImage): ?>
                            <img src="<?php echo e(\App\Helpers\FileHelper::url($event->bannerImage->url)); ?>" class="t5-polaroid-img" alt="Cover photo">
                        <?php else: ?>
            ...
            <div class="t5-celebrant-badge" style="<?php echo e($titleStyleStr); ?>"><?php echo nl2br(e($event->title)); ?></div>
        ...
        <div class="t5-card">
            ...
            <div class="t5-body-text" style="<?php echo e($descStyleStr); ?>">
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($firstMediaContent)): ?>
        <div class="t5-card" style="padding-top: 0;">
            <div class="t5-body-text text-left" style="<?php echo e($descStyleStr); ?>">
                <?php echo $firstMediaContent; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->galleryImages->count() > 0 && $event->event_date <= now()): ?>
        <div class="t5-card">
            <div class="t5-collage-grid">
                <?php
                    $slicedGallery = $event->galleryImages->take(3);
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slicedGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="t5-collage-item">
                    <div class="t5-polaroid">
                        <div class="t5-polaroid-img-wrap">
                            <img src="<?php echo e(\App\Helpers\FileHelper::url($block->url)); ?>" class="t5-polaroid-img" alt="">
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->caption): ?>
                            <div class="t5-polaroid-caption"><?php echo e($block->caption); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            ...
            <div class="t5-speakers-grid">
                ...
                <div class="t5-speaker-card">
                    <div class="t5-speaker-avatar">
                        ...
                        <?php else: ?>
                            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80" alt="<?php echo e($speaker->name); ?>">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="t5-speaker-name"><?php echo e($speaker->name); ?></div>
                    <div class="t5-speaker-role"><?php echo e($speaker->title); ?></div>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 mt-6">
                ...
                <div class="md:col-span-4 flex md:flex-col gap-2 overflow-x-auto md:overflow-x-visible pb-3 md:pb-0 scrollbar-none" style="-ms-overflow-style: none; scrollbar-width: none;">
                    ...
                    <button 
                        ...
                        :class="activeIndex === <?php echo e($index); ?> ? 'bg-[#982B37] text-white border-[#982B37]' : 'bg-slate-50 text-slate-700 hover:bg-slate-100 border-slate-200'"
        ...
        <div class="t5-card">
            ...
            <div class="t5-calendar-box">
                <div class="t5-cal-month-title">Tháng <?php echo e($eventDate->translatedFormat('F Y')); ?></div>
                <div class="t5-cal-grid">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < $startCell; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="t5-cal-day empty"></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($d = 1; $d <= $daysInMonth; $d++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="t5-cal-day <?php echo e($d == $calDay ? 'active' : ''); ?>"><?php echo e($d); ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
            
            <div class="t5-body-text font-bold">
                <?php echo e($eventDate->translatedFormat('l, d \t\h\á\n\g m \n\ă\m Y')); ?>

                <br>
                <span style="color: var(--t5-accent-pink);">
                    Thời gian: <?php echo e($eventDate->format('H:i')); ?>
        ...
        <div class="t5-card">
            ...
            <div class="t5-map-wrap">
                <iframe class="t5-map-iframe" src="https://maps.google.com/maps?q=<?php echo e(urlencode($event->location)); ?>&t=&z=14&ie=UTF8&iwloc=&output=embed"></iframe>
            </div>

            <div class="t5-address-text"><?php echo e($event->location); ?></div>
            <a href="https://www.google.com/maps/search/?api=1&query=<?php echo e(urlencode($event->location)); ?>" target="_blank" class="t5-phone-btn">
        ...
        <div class="t5-card">
            ...
            <div class="t5-countdown-wrap" id="t5-countdown" data-date="<?php echo e($event->event_date->format('Y-m-d\TH:i:s')); ?>">
        ...
        <div class="t5-card" style="display: flex; justify-content: space-between; align-items: center; gap: 20px; flex-wrap: wrap;">
            <div style="flex: 1; text-align: left;">
                ...
                <a href="<?php echo e(route('events.show', $previousEvent->slug)); ?>" style="text-decoration:none; color: var(--t5-text-dark);">
                    ...
                    <div style="font-family:'Fredoka One',cursive; font-size:16px;"><?php echo e($previousEvent->title); ?></div>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div style="flex: 1; text-align: right;">
                ...
                <a href="<?php echo e(route('events.show', $nextEvent->slug)); ?>" style="text-decoration:none; color: var(--t5-text-dark);">
                    ...
                    <div style="font-family:'Fredoka One',cursive; font-size:16px;"><?php echo e($nextEvent->title); ?></div>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<div class="t5-bottom-bar" x-data="{ copied: false }">
    <div class="t5-interaction-group">
        <a href="<?php echo e(route('home')); ?>" class="t5-action-btn" title="Về trang chủ">
            <span class="material-symbols-outlined">home</span>
        </a>
        <div class="t5-action-btn" title="Lượt xem">
            <span class="material-symbols-outlined">visibility</span>
            <span><?php echo e($event->views_count); ?></span>
        </div>
    </div>
    
    <div class="t5-interaction-group">
        <button id="t5-like-btn" class="t5-heart-btn <?php echo e(session()->has('liked_events.' . $event->id) ? 'liked' : ''); ?>" title="Thích sự kiện" data-event-id="<?php echo e($event->id); ?>">
            <span class="material-symbols-outlined <?php echo e(session()->has('liked_events.' . $event->id) ? 'font-fill' : ''); ?>">favorite</span>
            <span id="likes-count"><?php echo e($event->likes_count); ?></span>
        </button>
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(request()->url())); ?>" target="_blank" class="t5-action-btn" style="background: #1877F2; color: #fff; border: none;">
            Chia sẻ
        </a>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kienxinhzai\Downloads\ThucTap-tuan\resources\views/events/show-template5.blade.php ENDPATH**/ ?>