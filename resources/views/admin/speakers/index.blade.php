                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-border mt-2">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <form action="{{ route('admin.speakers.destroy', $speaker) }}" method="POST" class="inline" 
                                  onsubmit="return confirm('Bạn có chắc chắn muốn xóa diễn giả này không?');">
                                @csrf @method('DELETE')
                                <button type="submit" 
                                        class="h-7 w-7 rounded-md flex items-center justify-center text-muted-foreground hover:bg-red-50 hover:text-red-500 transition-all" title="Xóa">
