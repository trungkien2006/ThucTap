            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input class="uni-input" id="title" name="title" value="{{ old('title') }}" type="text" placeholder="VD: Giám đốc Nghiên cứu AI tại MIT Media Lab"/>
                    ...
                    <div>
                        ...
                        <select class="uni-input" id="type" name="type" required>
                            <option value="speaker" {{ old('type') == 'speaker' ? 'selected' : '' }}>Diễn giả</option>
                            <option value="guest" {{ old('type') == 'guest' ? 'selected' : '' }}>Khách mời</option>
                        </select>
