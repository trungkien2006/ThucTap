...
<div class="tp1-wrapper">
    ...
    <div class="tp1-hero">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->bannerImage): ?>
            <img src="<?php echo e(\App\Helpers\FileHelper::url($event->bannerImage->url)); ?>" class="tp1-hero-img" alt="<?php echo e($event->title); ?>">
        <?php else: ?>
        ...
        <div class="tp1-hero-content">
            ...
            <span class="tp1-badge"><?php echo e($event->category->name); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <h1 class="tp1-title"><?php echo e($event->title); ?></h1>
            <div class="tp1-meta">
                <div class="tp1-meta-item">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->end_date): ?>
                        ...
                        <?php else: ?>
                            - <?php echo e($event->end_date->format('d/m/Y H:i')); ?>
                ...
                <div class="tp1-meta-item"><span class="material-symbols-outlined">location_on</span> <?php echo e($event->location); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="flex justify-center gap-4 mt-8" id="countdown-wrapper" data-date="<?php echo e($event->event_date->format('Y-m-d\TH:i:s')); ?>">
    ...
    <div class="tp1-container">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($event->galleryImages) > 0): ?>
        <div class="tp1-card">
            ...
            <div class="tp1-grid <?php echo e($index % 2 == 0 ? 'left-img' : 'right-img'); ?>" style="<?php echo e($index > 0 ? 'margin-top: 64px;' : ''); ?>">
                    ...
                    <div class="tp1-img-col">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->url): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->type === 'video'): ?>
                                <video src="<?php echo e(\App\Helpers\FileHelper::url($block->url)); ?>" class="tp1-img" autoplay loop muted playsinline controls></video>
                            <?php else: ?>
                                <img src="<?php echo e(\App\Helpers\FileHelper::url($block->url)); ?>" class="tp1-img" alt="">
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="text-left">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->caption): ?>
                            <h3 style="font-size: 18px; font-weight: 700; margin-bottom: 8px;"><?php echo e($block->caption); ?></h3>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($block->content)): ?>
                            <div class="tp1-text"><?php echo $block->content; ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex flex-wrap gap-2 mt-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($block->action_url): ?>
                                <a href="<?php echo e($block->action_url); ?>" target="_blank" class="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-50 text-slate-600 rounded-lg text-sm font-medium hover:bg-slate-100 transition-colors border border-slate-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 mt-6">
                ...
                <div class="md:col-span-4 flex md:flex-col gap-2 overflow-x-auto md:overflow-x-visible pb-3 md:pb-0 scrollbar-none" style="-ms-overflow-style: none; scrollbar-width: none;">
                    ...
                    <button 
                        ...
                        :class="activeIndex === <?php echo e($index); ?> ? 'bg-[#f97316] text-white border-[#f97316]' : 'bg-slate-50 text-slate-700 hover:bg-slate-100 border-slate-200'"
                    ...
                    >
                        ...
                        <span><?php echo e($item->start_time->format('H:i')); ?><?php echo e($item->end_time ? ' - ' . $item->end_time->format('H:i') : ''); ?></span>
                    </button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
                    ...
                    <div x-show="activeIndex === <?php echo e($index); ?>" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-4">
                        <div>
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-orange-100 text-[#f97316] mb-3">
                                ...
                                <?php echo e($item->start_time->format('H:i')); ?><?php echo e($item->end_time ? ' - ' . $item->end_time->format('H:i') : ''); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speakers->count() > 0): ?>
            ...
            <div class="flex flex-wrap justify-center gap-6">
                ...
                <div class="flex flex-col items-center text-center p-6 rounded-xl border border-slate-100 bg-slate-50 hover:shadow-md transition-shadow w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] max-w-[320px]">
                    <img src="<?php echo e($speaker->photo_url ? asset($speaker->photo_url) : 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80'); ?>"
                         alt="<?php echo e($speaker->name); ?>" class="w-24 h-24 rounded-full object-cover mb-4 border-4 border-white shadow-sm">
                    <h3 class="font-bold text-lg text-slate-800"><?php echo e($speaker->name); ?></h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speaker->title): ?>
                        <p class="text-sm text-[#f97316] font-medium mb-3"><?php echo e($speaker->title); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speaker->bio): ?>
                        <p class="text-sm text-slate-600"><?php echo e($speaker->bio); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        ...
        <div class="mt-8 grid grid-cols-2 gap-4 md:gap-8 pt-8 border-t border-slate-200">
            <div>
                ...
                <a href="<?php echo e(route('events.show', $previousEvent->slug)); ?>" class="group block max-w-[280px] mr-auto">
                    ...
                    <div class="w-full h-[100px] md:h-[154px] rounded-xl overflow-hidden bg-slate-100 shadow-sm border border-slate-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($previousEvent->bannerImage): ?>
                            <img src="<?php echo e(\App\Helpers\FileHelper::url($previousEvent->bannerImage->url)); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <h4 class="mt-2 text-xs md:text-sm font-bold text-slate-800 group-hover:text-[#f97316] transition-colors line-clamp-2 text-left"><?php echo e($previousEvent->title); ?></h4>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="text-right">
                ...
                <a href="<?php echo e(route('events.show', $nextEvent->slug)); ?>" class="group block max-w-[280px] ml-auto">
                    <div class="flex items-center text-slate-500 group-hover:text-[#f97316] transition-colors mb-3">
                        <div class="h-[2px] bg-current flex-1"></div>
                        <span class="material-symbols-outlined text-2xl -mr-1">arrow_right_alt</span>
                    </div>
                    <div class="w-full h-[100px] md:h-[154px] rounded-xl overflow-hidden bg-slate-100 shadow-sm border border-slate-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextEvent->bannerImage): ?>
                            <img src="<?php echo e(\App\Helpers\FileHelper::url($nextEvent->bannerImage->url)); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <h4 class="mt-2 text-xs md:text-sm font-bold text-slate-800 group-hover:text-[#f97316] transition-colors line-clamp-2 text-right"><?php echo e($nextEvent->title); ?></h4>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\anima\Downloads\ThucTap-main\resources\views/events/show.blade.php ENDPATH**/ ?>