        ...
        <main class="tp-main">
            ...
            <div class="tp-grid-scroll">
                <div class="tp-grid cols-2" id="templateGrid">
                    ...
                    <!-- Template 7 -->
                    <div class="tp-card <?php echo e($event->page_template == 7 ? 'active' : ''); ?>" id="card-7" onclick="selectTemplate(7)" style="cursor: pointer;">
                        ...
                        <div class="tp-card-body">
                            <div class="flex justify-between items-start mb-1">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($event->page_template == 7): ?>
                                <span class="bg-orange-100 text-orange-600 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Đang dùng</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
        ...
        <aside class="tp-preview-panel" id="previewPanel">
            ...
            <div class="tp-preview-content">
                <div class="tp-iframe-wrap desktop" id="previewWrapper">
                    <iframe id="miniPreviewFrame" src="<?php echo e(route('admin.events.template_preview', $event->page_template ?? 1)); ?>" class="tp-iframe"></iframe>
                </div>
            </div>
...
<?php /**PATH C:\Users\kienxinhzai\Downloads\ThucTap-tuan\resources\views/admin/events/template-picker.blade.php ENDPATH**/ ?>