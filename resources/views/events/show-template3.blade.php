...
<div class="t3-body">
    ...
    <!-- Hero -->
    <div class="t3-hero" style="@if($event->bannerImage) background-image: linear-gradient(rgba(15,32,68,0.85), rgba(15,32,68,0.95)), url('{{ \App\Helpers\FileHelper::url($event->bannerImage->url) }}'); background-size: cover; background-position: center; @endif">
