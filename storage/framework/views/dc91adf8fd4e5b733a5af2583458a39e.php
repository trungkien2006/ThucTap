                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-nowrap items-center gap-3 w-full lg:flex-[2.5]">
                    ...
                    <div class="flex items-center justify-between gap-2 rounded-2xl px-3 h-11 border relative w-full lg:flex-1" 
                        ...
                        <select name="status" onchange="document.getElementById('events-filter-form').submit()"
                            ...
                            <option value="ongoing" <?php echo e((isset($selectedStatus) && $selectedStatus === 'ongoing') ? 'selected' : ''); ?>>Đang diễn ra</option>
                        </select>
                        <i data-lucide="chevron-down" class="h-3 w-3 shrink-0 text-[#7A6A52] absolute right-3 pointer-events-none"></i>
                    </div>
                    ...
                    <a href="<?php echo e(route('events.index')); ?>" class="h-11 px-4 rounded-2xl text-sm font-bold transition-all flex items-center justify-center gap-2 border hover:bg-slate-50 w-full lg:w-auto shrink-0"
